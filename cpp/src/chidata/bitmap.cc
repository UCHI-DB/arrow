...
namespace chidata {
    ...
    void SimpleBitmapIterator::move_to(uint64_t pos) {
        pointer_ = pos >> 6;
    ...
    bool SimpleBitmapIterator::has_next() {
    ...
    void FullBitmapIterator::move_to(uint64_t pos) {
        this->counter_ = pos;
    }

    bool FullBitmapIterator::has_next() {
    ...
    bool SimpleBitmap::is_full() {
        return size_ == cardinality();
    }

    bool SimpleBitmap::is_empty() {
    ...
    bool FullBitmap::is_full() {
        return true;
    }

    bool FullBitmap::is_empty() {
        return false;
    }
