...
//                    false, true));
        ...
        void executeQ3_3WithMemScan() {
            ...
            EncHashJoin orderSupplierJoin(LineOrder::SUPPKEY, Supplier::SUPPKEY, new WithCityBuilder(),
            ...
            EncHashJoin allJoin(0, Customer::CUSTKEY,
                                ...
                                {parquet::Type::type::INT32, parquet::Type::type::INT32,
                                 parquet::Type::type::INT32, parquet::Type::type::DOUBLE},
                                {EncodingType::PLAIN, EncodingType::PLAIN, EncodingType::DICTIONARY,
                                 EncodingType::PLAIN});
            auto allJoined = allJoin.join(*orderWithSupp, *filteredCustomer);
...
//                                         {lineorderTable});
            ...
            auto orderSupplierJoin = graph.add(
                    new encopr::EncHashTJoin<Hash32SparseContainer>(
